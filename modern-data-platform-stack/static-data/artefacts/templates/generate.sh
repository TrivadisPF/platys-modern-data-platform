...
jinja2 /templates/services-v1.md.j2 /variables/docker-compose.yml --format=yaml --outfile /output/services.md
jinja2 /templates/services-v2.md.j2 /variables/docker-compose.yml --format=yaml --outfile /output/services.md
